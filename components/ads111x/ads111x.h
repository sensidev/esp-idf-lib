...
#define ADS111X_MAX_VALUE 0x8000
 ...
 */
    typedef enum
    {
        ADS111X_MODE_CONTUNOUS = 0x0000,  //!< Continuous conversion mode
        ADS111X_MODE_SINGLE_SHOT = 0x0100 //!< Power-down single-shot mode (default)
    } ads111x_mode_t;
